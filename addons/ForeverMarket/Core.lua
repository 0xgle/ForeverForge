local ADDON, FM = ...
_G.ForeverMarket = FM
FM.name, FM.version, FM.author = ADDON, "1.1.2-beta1", "0xgle"
...
FM:On("PLAYER_LOGIN",function()
    ...
    if ForeverCore and ForeverCore.apiVersion==1 then
        ForeverCore:RegisterModule(ADDON,{title="ForeverMarket",description="Market search, selling and shopping lists.",icon=12,
