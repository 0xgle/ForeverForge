...
function M:Build()
    ...
    b:SetScript("OnEnter",function(self)
        GameTooltip:SetOwner(self,"ANCHOR_LEFT"); GameTooltip:AddLine("ForeverBags",1,0.82,0.35); GameTooltip:AddLine("Created by 0xgle",0.55,0.78,0.9); GameTooltip:AddLine("Left-click: inventory",0.8,0.8,0.8); GameTooltip:AddLine("Right-click: settings",0.8,0.8,0.8); GameTooltip:Show()
    end)
